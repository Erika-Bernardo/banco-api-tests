...
Este projeto realiza testes automatizados na API REST do [banco-api](https://github.com/Erika-Bernardo/banco-api-tests), validando suas funcionalidades e contribuindo a qualidade de suas operações.
